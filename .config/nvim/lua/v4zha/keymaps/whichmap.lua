local whichmap = {
  ...
  { "<leader>xx", "<cmd>Trouble diagnostics toggle focus=false win={relative=win,position=right,type=split} <cr>",             desc = "Diagnostics (Trouble)" },
  { "<leader>xX", "<cmd>Trouble diagnostics toggle focus=false win={relative=win,position=right,type=split} filter.buf=0<cr>", desc = "Buffer Diagnostics (Trouble)" },
